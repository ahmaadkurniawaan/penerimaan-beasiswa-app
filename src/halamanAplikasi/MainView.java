...
public class MainView extends javax.swing.JFrame {
    ...
    private void simpan() {
        ...
        try {
            String sql = "INSERT INTO mahasiswa VALUES ('" + fieldNim.getText() + "','" + fieldNama.getText() + "','" + fieldFakultas.getSelectedItem() + "','" + fieldprodi.getSelectedItem() + "','" + fieldAlamat.getText() + "','" + fieldJk.getSelectedItem() + "','" + fieldAyah.getText() + "','" + fieldGaji.getText() + "','" + fieldIpk.getText() + "','" + fieldAgama.getSelectedItem() + "','" + fieldUang.getText() + "')";
    ...
    private void cariDataPenerimaBeasiswa() {
        ...
        try {
            ...
            int no = 1;
            String sql = "SELECT * FROM mahasiswa WHERE nama LIKE '%" + key + "%' OR alamat LIKE '%" + key + "%' OR nim LIKE '%" + key + "%' OR nim LIKE '%" + key + "%' ";
            java.sql.Connection conn = (Connection) PenerimaanBeasiswa.ConfigDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void cariData() {
        ...
        try {
            ...
            int no = 1;
            String sql = "SELECT * FROM mahasiswa WHERE nama LIKE '%" + key + "%' OR alamat LIKE '%" + key + "%' OR nim LIKE '%" + key + "%' ";
            java.sql.Connection conn = (Connection) PenerimaanBeasiswa.ConfigDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        fieldprodi.setBackground(new java.awt.Color(255, 255, 255));
        ...
        fieldFakultas.setBackground(new java.awt.Color(255, 255, 255));
        ...
        fieldAgama.setBackground(new java.awt.Color(255, 255, 255));
